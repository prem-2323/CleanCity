...
export default function AssignStaffScreen() {
  ...
  const { staff, updateReport } = useReports();
          ...
          >
            <View style={styles.staffRow}>
              ...
              <View style={styles.staffInfo}>
                ...
                <Text style={styles.staffMeta}>{item.zone} - {item.activeTasks} active tasks</Text>
              </View>
              <View style={styles.staffStats}>
                ...
                <Text style={styles.workloadText}>{item.tasksCompleted} done</Text>
              </View>
...
const styles = StyleSheet.create({
  ...
  workloadText: { fontSize: 11, fontFamily: 'Inter_400Regular', color: Colors.gray400 },
